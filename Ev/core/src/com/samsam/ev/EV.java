...
public class EV extends Game {
	...
	public EV(ActionResolver actionResolver) {
	...
	public void create () {
		...
		categoryNames = new String[] {"a","b","c","d","e","f","g","h","i","j","k","l","m"
		...
		downloadUrls = new String[] {"1",d+"s/udkb01zfc0giv71/2.a?dl=1",d+"s/qr8ijwl8o8w1ida/3.a?dl=1",d+"s/a9ap8t2eec0pncq/4.a?dl=1",d+"s/zialcgi444em3ti/5.b?dl=1",d+"s/5i6kj8qh6t69ae3/6.b?dl=1",d+"s/qejhnop5og2fk9u/7.c?dl=1",d+"s/28poug2wecp6bjo/8.a?dl=1",
				d+"s/uaonupxa8ttafog/9.a?dl=1",d+"s/vpwlviq7dcpquhi/10.a?dl=1",d+"s/oyujt7f839i232j/11.a?dl=1",d+"s/t04rxe0705x3frp/12.b?dl=1",d+"s/ds0jskihcfihfee/13.a?dl=1",d+"s/k5nodn0fabb8yrx/14.a?dl=1",d+"s/9x8dx0y22tsc9kl/15.a?dl=1",
